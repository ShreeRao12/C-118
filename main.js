...
document.getElementById("sketch_suggestion").innerHTML = "Sketch to be drawn: " +Element_of_array;
...
function updateCanvas()
{
    background("white");
    sketch = Element_of_array;
    document.getElementById("sketch_suggestion").innerHTML = "Sketch to be drawn: " +sketch;
}
